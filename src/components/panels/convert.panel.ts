      ...
      components: [
        {
          ...
          label: "Maksimal (100%)",
          custom_id: `cv_q:${format}:100`,
        },
        {
          type: 2,
          style: quality === 80 ? 1 : 2,
          label: "Standar (80%)",
          custom_id: `cv_q:${format}:80`,
        },
        {
          type: 2,
          style: quality === 60 ? 1 : 2,
          label: "Hemat (60%)",
          custom_id: `cv_q:${format}:60`,
        },
      ],
    },
    // Row 3: Action Run
